 ...
 *
 * XDM Property Java Object Generated 2020-10-06 12:25:38.078327 -0700 PDT m=+2.438534954 by XDMTool
 */
...
public class BrowserDetails implements com.adobe.marketing.mobile.xdm.Property {
	...
	public Map<String, Object> serializeToXdm() {
		...
		if (this.acceptLanguage != null) { map.put("acceptLanguage", this.acceptLanguage); }
		...
		if (this.javaScriptVersion != null) { map.put("javaScriptVersion", this.javaScriptVersion); }
		if (this.javaVersion != null) { map.put("javaVersion", this.javaVersion); }
		if (this.name != null) { map.put("name", this.name); }
		if (this.quicktimeVersion != null) { map.put("quicktimeVersion", this.quicktimeVersion); }
		map.put("thirdPartyCookiesEnabled", this.thirdPartyCookiesEnabled);
		if (this.userAgent != null) { map.put("userAgent", this.userAgent); }
		if (this.vendor != null) { map.put("vendor", this.vendor); }
		if (this.version != null) { map.put("version", this.version); }
