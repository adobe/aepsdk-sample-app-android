 ...
 *
 * XDM Property Java Object Generated 2020-10-01 16:36:16.051995 -0700 PDT m=+1.899856412 by XDMTool
 */
...
public class Environment implements com.adobe.marketing.mobile.xdm.Property {
	...
	public Map<String, Object> serializeToXdm() {
		...
		if (this.browserDetails != null) { map.put("browserDetails", this.browserDetails.serializeToXdm()); }
		if (this.carrier != null) { map.put("carrier", this.carrier); }
		map.put("colorDepth", this.colorDepth);
		if (this.connectionType != null) { map.put("connectionType", this.connectionType.toString()); }
		if (this.domain != null) { map.put("domain", this.domain); }
		if (this.iSP != null) { map.put("ISP", this.iSP); }
		if (this.ipV4 != null) { map.put("ipV4", this.ipV4); }
		if (this.ipV6 != null) { map.put("ipV6", this.ipV6); }
		if (this.language != null) { map.put("language", this.language); }
		if (this.operatingSystemVendor != null) { map.put("operatingSystemVendor", this.operatingSystemVendor); }
		if (this.operatingSystemVersion != null) { map.put("operatingSystemVersion", this.operatingSystemVersion); }
		if (this.operatingSystem != null) { map.put("operatingSystem", this.operatingSystem); }
		if (this.type != null) { map.put("type", this.type.toString()); }
