 ...
 *
 * XDM Property Java Object Generated 2020-10-01 16:36:16.048561 -0700 PDT m=+1.896422417 by XDMTool
 */
...
public class Geo implements com.adobe.marketing.mobile.xdm.Property {
	...
	public Map<String, Object> serializeToXdm() {
		...
		if (this.city != null) { map.put("city", this.city); }
		if (this.countryCode != null) { map.put("countryCode", this.countryCode); }
		...
		if (this.postalCode != null) { map.put("postalCode", this.postalCode); }
		if (this.stateProvince != null) { map.put("stateProvince", this.stateProvince); }
